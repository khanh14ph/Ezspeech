...
class RNNTLossPytorch(torch.nn.modules.loss._Loss):
...
class TDTLossPytorch(torch.nn.modules.loss._Loss):
...
class MultiblankRNNTLossPytorch(torch.nn.modules.loss._Loss):
