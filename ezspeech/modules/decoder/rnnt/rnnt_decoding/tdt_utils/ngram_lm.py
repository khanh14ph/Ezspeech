...
from ezspeech.modules.decoder.rnnt.rnnt_decoding.tdt_utils.optional_libs import (
    TRITON_AVAILABLE,
    triton_required,
    kenlm_required,
)
...
if TRITON_AVAILABLE:
    ...
    from ezspeech.modules.decoder.rnnt.rnnt_decoding.tdt_utils.ngram_lm_triton import (
...
class NGramGPULanguageModel(LightningModule):
    """
    ...
    def get_final(self, states: torch.Tensor) -> torch.Tensor:
        ...
        print("Final weights are not resolved; using slow implementation")
