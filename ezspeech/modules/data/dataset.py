...
from ezspeech.modules.dataset.utils.text import Tokenizer, tokenize
...
class ASRDatasetBilingual(Dataset):
    def __init__(
        ...
        self.tokenizer_extra = Tokenizer(
            "/home4/khanhnd/Ezspeech/ezspeech/resource/tokenizer/vi/vocab.txt",
